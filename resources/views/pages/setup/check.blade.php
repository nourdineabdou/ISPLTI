...
$strOk = '<i style="color: #22bb33;" class="la la-check"></i>';
$strFail = '<i style=" color: red; " class="la la-times"></i>';
...
<div class="row mt-3 p-5" >
    ...
    @if ($allValuesAreTrue)
        <div class="offset-6 col-6 col-md-6">
            <a href="/setup/step-1" id="next"  class="btn btn-outline-danger mt-3 float-md-right" > Next Step <i class="la la-angle-right"></i></a>
        </div>
    @endif
</div>
