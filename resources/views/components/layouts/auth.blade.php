<!DOCTYPE html>
<html class="loading" lang="{{ app()->getLocale() ?? 'fr' }}" data-textdirection="ltr">
<!-- BEGIN: Head-->
...
<body class="vertical-layout vertical-menu 1-column  bg-cyan bg-lighten-2 fixed-navbar" data-open="click" data-menu="vertical-menu" data-col="1-column">
    ...
    <div class="navbar-wrapper">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item"><a class="navbar-brand" href="{{ route('home') }}"><img class="brand-logo" alt="modern admin logo" src="../../../app-assets/images/logo/logo.png">
                        <h3 class="brand-text">
                            Institustion Name
                        </h3>
                    </a></li>
